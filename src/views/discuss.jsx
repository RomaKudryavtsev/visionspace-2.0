    ...
    return (
        <div className="discuss-bg">
            <section className="flex flex-col gap-7.5 items-center">
                <div className="flex flex-col gap-3.5 max-w-4xl w-full">
                    <h2 className="text-center text-4xl lg:text-5xl text-primary font-semibold">{ $t('project_form.title', lang) }</h2>
