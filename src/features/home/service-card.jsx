...
export default function ServiceCard({
    ...
    return (
        <div
            className="bg-white p-5 flex flex-col gap-3.5 rounded-xl w-full max-w-95 lg:w-100 lg:max-w-none min-h-0 lg:min-h-127"
            style={ { boxShadow: '0px 4px 15px 0px #22262D0D' } }
        >
            <div className="flex gap-4 lg:gap-7.5">
                <div
